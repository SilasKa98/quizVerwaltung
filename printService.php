                ...
                <div class="container-fluid">
                    <div class="btn-group rightOuterMenu">
                        ...
                        <ul class="dropdown-menu outerMenuItems">
                            ...
                            <li class="outerMenuItemsListElem"><a class="dropdown-item add-to-cart" href="#"><img src="/quizVerwaltung/media/basket-shopping.svg" width="20px"></a></li>';
                      ...
                      print'</div>
                        ...
                        <div class="collapse" id="collapsable_'.$questionObject[$i]->id.'">';
                            print'<div class="card-body">';
                                ...
                                print'<p "card-text">Author: <a href="/quizVerwaltung/frontend/userProfile.php?profileUsername='.$questionObject[$i]->author.'"><span class="badge rounded-pill text-bg-primary authorPill" style="margin-right: 2px;">'.$questionObject[$i]->author."</span></a></p>";
                            print'</div>
                        </div>
                    </div> 
                </div>      
